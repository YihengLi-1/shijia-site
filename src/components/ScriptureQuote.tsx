...
function pickNextIndex() {
  const key = "scripture_quote_index_v1";
  const usedKey = "scripture_quote_used_v1";
...
export default function ScriptureQuote({
  ...
  return (
    <div
      className={`rounded-2xl border border-zinc-200/70 bg-white/80 px-5 py-4 shadow-sm ${className}`}
    >
